...
class BiomeAgent(BaseAgent):
    ...
    #     self, dataset: str, schema: str, agent: AgentRef,
    #     loop: LoopControllerRef
    # ) -> str:
    #     """
    ...
    #         schema (str): The schema to use for the input dataset.
    #     Returns:
    ...
    #         parent_header={},
    #     )
    #     return f"Input dataset set to {dataset}"

    # # @tool()
    # # async def pick_schema(self, schema_name: str, agent: AgentRef) -> str:
    # #     """
    ...
    # #     Returns:
    # #         str: returns the schema str that corresponds to the given schema name.
    # #     """
    ...
    #     Before running this function, you MUST ALWAYS set the input dataset using the `set_input_dataset` tool.

    #     Args:
    #         output_dataset (str): An output dataset on which to run the workload.
    #         schema (str): The schema to use for the output dataset.
